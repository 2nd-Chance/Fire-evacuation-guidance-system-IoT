...
#define INTROSPECTION_FILE_NAME		"sensor_introspection.dat"


static SensorResource _sensor_resource;
...
{
	_duplicate_string(&_platform_info.platformID, "0A3E0D6F-DBF5-404E-8719-D6880042463B");
...
int main(void)
{
	...
	cout << "Start sensor server..." << endl;

	_setup();

	try
	{
		_sensor_resource.CreateResource();
